...
resource "aws_autoscaling_group" "catalogue" {
  ...
  instance_refresh {
    ...
    triggers = ["launch_template"] #when should it refresh? only when launch_template is updated then only it should refresh
  }
...
#deleteing catalgue after the work is done..i.e after autopolicy gorup
